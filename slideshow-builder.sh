...
ITEM=$2
AUDIO_FILE=$3
PIC_DIR="FILES_$MODE-$ITEM"
OUTPUT_VIDEO="video.mp4"
SLIDE_DURATION=0.2
URL="https://unsplash.com/napi/$MODE/$ITEM/photos?page=1&per_page=25"
...
curl -sS $URL | grep -Eoi '"full":"[^\"]+"' | sed -E 's/("full":")(.*)(photo.*)(\?.*)"/\2\3\4 -o \3.jpg/' | xargs -n 3 curl -s
...
cp $OUTPUT_VIDEO "../$MODE_$ITEM.mp4"